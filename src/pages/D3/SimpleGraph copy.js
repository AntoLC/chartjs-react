...
const SimpleGraph = function(elemid, options) {
    ...
    // x-scale
    console.debug("scale1", this.chart);
    ...
    this.plot.call(d3.zoom().on("zoom", this.redraw(this.x, this.y)));
...
SimpleGraph.prototype.redraw = function(_x, _y) {
    var self = this;
    return function() {
        var tx = function(d) { 
            //return "translate(" + self.x(d) + ",0)"; 
            return "translate(" + _x(d) + ",0)"; 
